...
> 权威集 2652 个插件 · 生成于 2026-09-06 · 由 DSH Insights 管线生成

## 总览
- 权威集规模：**2652**
- 近 30 天活跃：2652（100%）
- 仓库年龄 ≥ 1 天（可过收录门禁）：2647（99.8%）

## 发布与文档
- npm 已发布 1317 / 未发布 1335 / 已发布但版本滞后 328
- 有 README 2639 · 中英双语/中文 987 · 中文 README 文件 273 · 无 README 13
- lib/index.js 1196 · lib/client.js 965 · 双产物 864

## 收录渠道（curated 覆盖）
- awesome-dsh-plugin 757 · imsai 236 · 至少一个渠道 988（37.3%） · 未收录 1664
...
## 质量评分（启发式）
- 平均分 87.2 · A+B 占比 99.5%
- A 1280 · B 1359 · C 13 · D 0
